        ...
        <div>
            ...
            <defs>
                <linearGradient id="colorcases" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="rgb(255, 41, 41)" stopOpacity={0.5}/>
                    <stop offset="95%" stopColor="rgb(255, 41, 41)" stopOpacity={0}/>
                </linearGradient>
                <linearGradient id="colordeaths" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="rgb(0, 0, 0)" stopOpacity={0.5}/>
                    <stop offset="95%" stopColor="rgb(0, 0, 0)" stopOpacity={0}/>
                </linearGradient>
                <linearGradient id="colorrecovered" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="rgb(37, 255, 37)" stopOpacity={0.5}/>
